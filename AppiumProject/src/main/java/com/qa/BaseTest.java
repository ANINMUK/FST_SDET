...
public class BaseTest {
	...
	@BeforeSuite
//	@Parameters({"Android", "emulator-5554", "Pixel_4"})
	public void setup(String platformName, String udid, String deviceName) throws AppiumServerHasNotBeenStartedLocallyException, Exception {
		...
		try {
			...
			caps.setCapability(MobileCapabilityType.UDID, "emulator_5554");
			...
			caps.setCapability(MobileCapabilityType.APP,
					"C:\\Users\\ibmadmin\\Downloads\\src\\test\\resources\\app\\Android.SauceLabs.Mobile.Sample.app.2.7.1.apk");
